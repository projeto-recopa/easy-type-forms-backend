...
namespace image_cloud_processor.Service
{
    public class UploadService
    {
            ...
            IDocumentosRepository<Document> documentosRepository)
        {
            ...
            PredictMLEndpoint = configuration.GetValue<string>("PredictEndPoint");
        }
        ...
        public void ProcessarDadosOriginaisAsync(Document documento)
        {
            ...
            documento.CPF = removeNIndexCharacters
                (this.ExtractFieldByRegex(fullText, patternCPF, "CPF"));
            documento.CNS =  removeNIndexCharacters
                (this.ExtractFieldByRegex(fullText, patternCNS, "CNS"));
